 ...
 */
public class BDWMSpider implements Spider {

	private final Log log = LogFactory.getLog(BDWMSpider.class.getSimpleName());
	...
	public BDWMSpider() throws Exception {
		this.seed = "bdwm";
	...
	class PostHandler extends DefaultHandler {
		...
		public PostHandler() {
			dateFormat = new SimpleDateFormat("EEE MMM dd HH:mm:ss yyyy", new Locale("en"));
		}
